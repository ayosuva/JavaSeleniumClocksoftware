...
public class ExtraServicesPage extends PageBase {
    ...
    By input_Airport_Transfer_AddOn=By.xpath("//*[contains(text(),'Airport')]/following::div[3]//input[@placeholder='Quantity']");
    By input_Business_Services_AddOn=By.xpath("//*[contains(text(),'Business')]/following::div[3]//input[@placeholder='Quantity']");
